...
📮 *Note:*
• Owner IyanOfficialF1 tidak menerima save contact
• Owner IyanOfficialF1 berhak blockir tanpa alasan
• Berbicaralah yang sopan & tidak spam
• Owner ReysaOfficialF1 Hanya merespon yang berkaitan dengan BOT
• No Telp owner IyanOfficialF1`
...
const sections = [
   {
	title: `${htjava} OWNER –––––––––·•`,
	rows: [
	    {title: "📱 • Nomor iyan", rowId: ".owner nomor"},
	{title: "🎨 • Biodata Iyan", rowId: ".owner bio"},
